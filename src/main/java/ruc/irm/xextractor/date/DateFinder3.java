 ...
 */
class DateFinder3 extends Finder {
    //2016/12/21 09:22:00
    ...
    public void validate(){
        check("2016-12-21 09:22:00", "2016/12/21");
        check("2016年12月21日 09:22:00", "2016/12/21");
        check("2016年2月1日 09:22:00", "2016/02/01");
        check("2016/12/21 09:22:00", "2016/12/21");
        check("2016.12.21 09:22:00", "2016/12/21");
        check("2016.2.21 9:1:00", "2016/02/21");
    }
}
